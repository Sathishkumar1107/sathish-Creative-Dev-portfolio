...
var typed = new Typed(".typing-text", {
	strings: ["Creative Developer", "Digital Graphic Designer", "Creative Specialist", "Rich Media Developer", "HTML5 Animator", "DCO Specialist", "Email Developer"],
	loop: true,
	typeSpeed: 50,
	backSpeed: 25,
	backDelay: 500,
...
const frame =
	document.getElementById("bannerFrame");
...
videoCards.forEach(card => {
	...
	card.addEventListener("click", (e) => {
		...
		const width =
			parseInt(card.dataset.width);

		const height =
			parseInt(card.dataset.height);
